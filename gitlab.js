...
function GitlabParseURLInfo(url){
  ...
  url_info_array = lodash.clone(url_info_array);
  [projectInfo.groupname,projectInfo.projectname,projectInfo.type,projectInfo.mr] = lodash.filter(url_info_array,(o)=>{return o !== "-";});
